    ...
    return (
      <View style={[{ width: '100%',height: 150, backgroundColor: '#f9f1f1', marginBottom: 10, borderRadius: 10 ,padding: 10},item.RelationshipTitlePlang == 'Self' && { borderWidth: 1, borderColor: '#dc3545' } ]}>
        ...
        <View style={{ flexDirection: 'row',  width: '100%',justifyContent: 'space-between',paddingTop: 10 }}>
          <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#000' }}>{`صلة القرابة: ${item.RelationshipTitleSlang}`}</Text>
          <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#000' }}>{`تاريخ الإضافة : ${moment(item.CreatedDate).format('DD/MM/YYYY')}`}</Text>
        </View>
        <View style={{ flexDirection: 'row',  width: '100%',justifyContent: 'space-between',marginTop: 20 }}>
          <TouchableOpacity style={{ height:40,width:'48%', backgroundColor: '#23a2a4', borderRadius: 10,justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ color: '#fff', fontSize: 12, fontWeight: 'bold' }}>التقارير الطبية</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ height:40,width:'48%', backgroundColor: '#23a2a4', borderRadius: 10,justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ color: '#fff', fontSize: 12, fontWeight: 'bold' }}>التاريخ المرضي</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ paddingHorizontal: 16, paddingVertical: 10, alignItems: 'center', }}>
        <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#000', marginBottom: 10 }}>المستفيدون (المرضى)</Text>
        <Text style={{ fontSize: 14, fontWeight: '500', color: '#000', marginBottom: 10 }}>يمكنك إضافة أكثر من مستفيد، مع إضافة التاريخ المرضي والتقارير الطبية لكل مستفيد</Text>
      </View>
      ...
      <View style={styles.contentContainer}>
        <FlatList
          ...
          ListEmptyComponent={() => <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 100 }}>
            <Text style={{ fontSize: 16, fontWeight: '500', color: '#000' }}>{t('no_beneficiaries')}</Text>
          </View>}
        />
      </View>
      <TouchableOpacity style={{ height: 50,marginTop: 10, backgroundColor: '#23a2a4', marginHorizontal: 10, marginBottom: 10, borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
        <Text style={{ color: '#fff', fontSize: 16, fontWeight: 'bold' }}>{t('add_beneficiary')}</Text>
      </TouchableOpacity>
